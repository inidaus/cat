...
class Peserta extends BaseController
{
    ...
    {
$this->userModel->save([
  'username' => $this->request->getPost('nim'), // atau 'nip'
...
public function toggle($id)
{
    ...
    if ($user && $user['role'] === 'peserta') {
        ...
        if ($this->request->isAJAX()) {
            ...
            return redirect()->to('admin/peserta')->with('success', 'Status peserta berhasil diubah');
        }
    } else {
        if ($this->request->isAJAX()) {
            echo json_encode([
    ...
    public function import()
    {
        ...
        return redirect()->to('admin/peserta')->with('success', $message);
    }
