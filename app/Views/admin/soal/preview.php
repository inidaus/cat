  ...
  <div class="preview-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('admin/soal/edit/' . $soal['id']) ?>" class="btn btn-warning btn-sm" target="_blank">
    ...
    <div class="row mb-4">
      <div class="col-md-12">
        <div class="d-flex flex-wrap gap-2">
          ...
          <span class="info-badge badge-pembimbing">
            <i class="fas fa-user me-1"></i> <?= esc($soal['pembimbing']) ?>
          </span>
