...
<div class="modal fade" id="modalTambah" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url('pembimbing/kategori/store') ?>" method="post">
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url('pembimbing/kategori/update') ?>" method="post">
        <div class="modal-header">
...
function confirmDelete(id, nama) {
  if (confirm(`Yakin ingin menghapus kategori "${nama}"?`)) {
    ...
    form.method = 'POST';
    form.action = `<?= base_url('pembimbing/kategori/delete/') ?>${id}`;
