...
/* Pastikan modal bisa diklik untuk close */
.modal-backdrop.show {
  opacity: 0.6 !important;
}

/* Override glass-wrapper yang mungkin interfere */
.glass-wrapper .modal {
  position: fixed !important;
}

/* Pastikan tombol close terlihat */
.btn-close-white {
...
<div class="glass-wrapper">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 style="color: white; text-shadow: 1px 1px 2px rgba(0,0,0,0.7);">
      <i class="fas fa-chart-line me-2"></i> Detail Laporan
    </h2>
    <div>
      <a href="<?= base_url('pembimbing/laporan/export/' . $ujian['id']) ?>"
         class="btn btn-export me-2">
        <i class="fas fa-download me-1"></i> Export CSV
      </a>
      <a href="<?= base_url('pembimbing/laporan') ?>" class="btn btn-outline-light btn-sm">
              ...
              <tr>
                ...
                <td>
                  <?php if (in_array($hasil['status'], ['selesai', 'timeout']) && !empty($hasil['hasil_per_mata_pelajaran'])): ?>
                    ...
                    <!-- Modal Detail -->
                    <div class="modal fade" id="detailModal<?= $hasil['peserta_id'] ?>" tabindex="-1"
                         aria-labelledby="detailModalLabel<?= $hasil['peserta_id'] ?>" aria-hidden="true"
                         data-bs-backdrop="true" data-bs-keyboard="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content" style="background: #2c3e50; border: 1px solid rgba(255,255,255,0.2);">
                          <div class="modal-header" style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                            <h5 class="modal-title text-white" id="detailModalLabel<?= $hasil['peserta_id'] ?>">
                              Detail Hasil - <?= esc($hasil['nama_lengkap']) ?>
                            </h5>
...
window.emergencyCloseModal = function() {
  ...
  // Also clean up any Bootstrap modals that might be stuck
