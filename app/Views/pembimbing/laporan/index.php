...
<div class="glass-wrapper">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 style="color: white; text-shadow: 1px 1px 2px rgba(0,0,0,0.7);">
      <i class="fas fa-chart-bar me-2"></i> Laporan Hasil Ujian
    </h2>
  ...
  <?php if (empty($ujian_list)): ?>
    <div class="laporan-card text-center">
      ...
      <p class="text-white-50 mb-3">Anda belum membuat ujian apapun untuk dilihat laporannya</p>
        ...
        <div class="col-lg-6 col-md-12 mb-4">
          <div class="laporan-card">
            ...
            <div class="text-center">
              <a href="<?= base_url('pembimbing/laporan/detail/' . $ujian['id']) ?>" 
