  ...
  <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center">
      ...
      <div class="btn-group" role="group">
        ...
        <a href="<?= base_url('pembimbing/peserta/export') ?>" class="btn btn-export btn-sm">
          <i class="fas fa-file-export me-1"></i>Export
        </a>
        <a href="<?= base_url('pembimbing/peserta/template') ?>" class="btn btn-outline-light btn-sm">
        ...
        <div class="card peserta-card text-white">
          ...
          <div class="card-body text-center p-3">
            ...
            <div class="d-flex justify-content-center align-items-center gap-2 mt-3">
              <form action="<?= base_url('pembimbing/peserta/toggle/' . $p['id']) ?>" method="post" class="d-inline">
            ...
            <div class="d-flex justify-content-center gap-1 mt-3">
              ...
              <form action="<?= base_url('pembimbing/peserta/delete/' . $p['id']) ?>" method="post"
...
<div class="modal fade modal-modern" id="modalTambah" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pembimbing/peserta/save') ?>" method="post">
...
<div class="modal fade modal-modern" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pembimbing/peserta/update') ?>" method="post">
...
<div class="modal fade modal-modern" id="modalImport" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pembimbing/peserta/import') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
