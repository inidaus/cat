  ...
  <div class="form-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('pembimbing/soal/preview/' . $soal['id']) ?>" class="btn btn-info btn-sm" target="_blank">
          <i class="fas fa-eye me-1"></i> Preview
        </a>
        <a href="<?= base_url('pembimbing/soal/duplicate/' . $soal['id']) ?>" class="btn btn-success btn-sm">
    ...
    <form action="<?= base_url('pembimbing/soal/update') ?>" method="post">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-4">
          ...
          <input type="number" name="bobot" class="form-control" value="<?= $soal['bobot'] ?>" min="1" max="100" required>
        </div>
      </div>
